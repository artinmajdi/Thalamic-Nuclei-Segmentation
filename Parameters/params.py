...
from Parameters import UserInfo, Classes
...
WhichExperiment.Nucleus.Index = UserInfo.nucleus_Index if WhichExperiment.HardParams.Model.MultiClass.mode else [UserInfo.nucleus_Index[0]]
...
del Classes, LossFunction, Metrics, Optimizers, UserInfo, smallFuncs, datasets, os, sys, _